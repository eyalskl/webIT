<template>
  <div class="color-picker flex column">
      <div class="colors-container flex wrap justify-center">
        ...
        <span @click.stop="setColor('#ffffff')" :class="{picked : pickedColor === '#fff'}" style="backgroundColor : #fff"> </span>
        <span @click.stop="setColor('#000000')" :class="{picked : pickedColor === '#000'}" style="backgroundColor : #000"> </span>
...
export default {
    data() {
        return {
            startFrom: 0,
            colors: _.flatten(colors).slice(this.startFrom, 24),
            pickedColor: ''
        }
    },
    methods: {
        ...
        showMore() {
            ...
            else this.startFrom += 24;
            this.colors = _.flatten(colors).slice(this.startFrom, this.startFrom + 24)
        }
    },
}
</script>
