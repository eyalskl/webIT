<template>
  <div class="home-page">
    ...
    >
      ...
      <g id="computer">
        ...
        />
        <rect
          class="cat-btn-computer"
          x="423.3"
          y="286.1"
          style="fill:#0076df;stroke:#070808;stroke-miterlimit:10;"
          width="341"
          height="211.3"
      ...
      <g id="lamp">
        <g id="lamp-body">
          <g id="lamp-header">
            <g id="lamp-line-t">
              <polyline
                style="fill:#005bac;stroke:#0B0B0B;stroke-miterlimit:10;"
    ...
    c3.3-6.8,7.6-20.6-5-31.8L225.9,393.2z"
              />
              <path
                style="fill:#0076df;stroke:#0B0B0B;stroke-miterlimit:10;"
  ...
  H81.6z"
        ...
        C192.9,335.1,186,345.2,182.3,357.8z"
          ...
          />
          <path style="fill:#41a5ff;" d="M83,590.7H122l-8.3-27.8C90.4,569.8,83,590.7,83,590.7z" />
          <path
    ...
    <!-- <section class="overview">
      <section class="responsive">
        ...
        <h3>Build Responsive Webpages</h3>
      </section>
